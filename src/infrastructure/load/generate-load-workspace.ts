...
export function generateLoadWorkspace(options: LoadWorkspaceOptions = {}): WorkspaceSnapshot {
  ...
  return {
    ...
    statuses: [{ id: 'unvisited', label: 'Pas visite', color: '#8C9494', order: 0, active: true }],
